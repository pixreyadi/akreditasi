<div class="col-md-12 content-header">
	<b>Pengisian</b> <small><small>Standar 1</small></small>
</div>
<div class="col-md-12 content-data">
	<div class="col-md-12 box">
		<div class="box-header">
			<i class="fa fa-list"></i> <b>Form Standar 1</b>
		</div>
		<div class="col-md-12 box-content">
			<div class="form-group">
	            <input type="hidden" id="profil" />
	            <label for="exampleInputEmail1">Mekanisme penyusunan visi, misi, tujuan dan sasaran program studi serta pihak-pihak yang dilibatkan </label>
